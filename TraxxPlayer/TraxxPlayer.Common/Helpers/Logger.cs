...
namespace TraxxPlayer.Common.Helpers
{
    ...
    {
        public static void LogInfo(object sender, UserToAddAndDisplay user, string infoMessage, [CallerMemberName]string memberName = "")
        {
        ...
        public static void LogWarning(object sender, UserToAddAndDisplay user, string warningMessage, [CallerMemberName]string memberName = "")
        {
            var userID = user != null ? user.id : -1;
        ...
        public static void LogError(object sender, UserToAddAndDisplay user, string errorMessage, [CallerMemberName]string memberName = "")
        {
            var userID = user != null ? user.id : -1;
